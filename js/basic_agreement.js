function demo(input) {
    ...
    doc.text(20, 50, '        [name]	 (Mother) and 	    [name]        (Father), the biological parents (Parents) of 	 ');
    doc.text(20, 55, '[name]        (Child), in the interest of cooperative parenting for the mental, physical, financial, and ');
    ...
    doc.text(25, 75, 'a.	Child’s residence');
    doc.text(30, 80, 'i.');
    doc.text(35, 80, 'Mother shall have [sole/primary/shared] physical custody of Child [#] day(s) per week.');
    doc.text(30, 85, 'ii.');
    doc.text(35, 85, 'Father shall have [sole/primary/shared] physical custody of Child [#] day(s) per week.');
    doc.text(25, 90, 'b.	Schedule flexibility');
    doc.text(30, 95, 'i.');
